...
07.04.2023 в конфигурацию добавленно обязательное поле AuthType
может принимать следующие параметры
 - WithSecretKey - автоматическа авторизация по ключу SharedSecret
 - Console - авторизация в ручном режиме через ввод кода в консоле
 - Device - авторизация в ручном режиме через подтверждение кода через мобильное приложенгие
